...
checked binding used before Type IR v1 is available. Enumeration, default,
bounded sequence, variant, compatibility-edge, and borrowed-visitor fixtures
are added before claiming complete Profile 1 derivation.
