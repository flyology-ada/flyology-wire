...
package Generated_Profile_1_Test_Codec is
   ...
   Accepted_Writer_1_Schema : constant Flyology_Wire.Codecs.Schema_Identity :=
   ...
   Accepted_Writer_1_Maximum_Encoded_Size : constant Flyology_Wire.Byte_Count :=
     12;

   Accepted_Writer_2_Schema : constant Flyology_Wire.Codecs.Schema_Identity :=
     (Family      => Local_Schema.Family,
      Fingerprint =>
        Flyology_Wire.Identities.Fingerprint_From_Bytes
          ([16#00#,
      ...
      Revision    => 3,
      Profile     => Local_Schema.Profile);
   Accepted_Writer_2_Maximum_Encoded_Size : constant Flyology_Wire.Byte_Count :=
     18;
